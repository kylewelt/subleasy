...
s = Sublet.create(name: "Cool Digz", owner: u, price: 4000, start_date: Date.parse('Aug 1, 2017'), end_date: Date.parse('Jan 1, 2018'), location: l)
...
s2 = Sublet.create(name: "Random Digz", owner: u2, price: 6000, start_date: Date.parse('Sep 1, 2017'), end_date: Date.parse('Sep 1, 2018'), location: l2)
